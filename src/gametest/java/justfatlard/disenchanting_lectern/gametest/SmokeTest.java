package justfatlard.disenchanting_lectern.gametest;
...
public final class SmokeTest implements FabricClientGameTest {
	...
	public void runTest(ClientGameTestContext context) {
		if (!FabricLoader.getInstance().isModLoaded("disenchanting-lectern-justfatlard")) {
			throw new AssertionError("disenchanting-lectern-justfatlard is not loaded: the test is testing nothing");
		}
